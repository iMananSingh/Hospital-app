    ...
    <div>
      ...
      <div className="px-6 pb-6 pt-4">
        ...
        <Card>
          ...
          <CardContent className="p-6" style={{ display: 'flex', flexDirection: 'column', height: 'auto' }}>
            {/* Inner Card - Header Only */}
            <Card style={{ marginBottom: '0px', borderBottomLeftRadius: '0px', borderBottomRightRadius: '0px' }}>
            ...
            {/* Table - Outside Card with Scrollbar */}
            {isLoadingAdmissions || isLoadingPatients ? (
                <div className="text-center py-8" style={{ backgroundColor: '#FFFFFF', borderBottomLeftRadius: '0.5rem', borderBottomRightRadius: '0.5rem', border: '1px solid hsl(var(--border))' }}>
                ...
                <>
                  ...
                  <Table className="border-collapse" style={{ width: '100%', tableLayout: 'fixed', backgroundColor: '#FFFFFF' }}>
                    <TableHeader>
                      <TableRow style={{ backgroundColor: '#F7F7F7' }}>
                        <TableHead className="pt-[0px] pb-[0px]" style={{ width: '15%' }}>Admission ID</TableHead>
                        <TableHead className="pt-[0px] pb-[0px]" style={{ width: '22%' }}>Patient</TableHead>
                  ...
                  <div className="overflow-y-auto scrollbar-peach" style={{ height: 'calc(100vh - 480px - 49px)', scrollbarGutter: 'stable', width: '100%', paddingRight: '0px', backgroundColor: '#FFFFFF', borderBottomLeftRadius: '0.5rem', borderBottomRightRadius: '0.5rem', border: '1px solid hsl(var(--border))', borderTop: 'none' }}>
                    <Table className="border-collapse" style={{ width: '100%', tableLayout: 'fixed' }}>
                      <TableBody>
                        {filteredAdmissions.map((admission) => (
                          <TableRow key={admission.id}>
                            ...
                            <TableCell className="border-l-2" style={{ width: '8%' }}>
                ...
                <div className="text-center py-8 px-6" style={{ backgroundColor: '#FFFFFF', borderBottomLeftRadius: '0.5rem', borderBottomRightRadius: '0.5rem', border: '1px solid hsl(var(--border))' }}>
