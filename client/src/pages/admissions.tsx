                      ...
                      <Table className="border-collapse">
                        <TableHeader>
                          <TableRow style={{ backgroundColor: '#F7F7F7' }}>
                            <TableHead className="pt-[0px] pb-[0px]" style={{ width: '160px', minWidth: '160px', maxWidth: '160px' }}>Admission ID</TableHead>
                            ...
                            <TableHead className="border-l-2 text-center pt-[0px] pb-[0px]" style={{ width: '122px', minWidth: '122px', maxWidth: '122px' }}>View</TableHead>
                          </TableRow>
                        </TableHeader>
                      </Table>
                          ...
                          <TableBody>
                            {filteredAdmissions.map((admission) => (
                              <TableRow key={admission.id}>
                                <TableCell className="font-medium" style={{ width: '160px', minWidth: '160px', maxWidth: '160px' }}>
                                ...
                                <TableCell className="border-l-2" style={{ width: '122px', minWidth: '122px', maxWidth: '122px' }}>
