...
export function ReceiptTemplate({ receiptData, hospitalInfo, onPrint }: ReceiptTemplateProps) {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="sm"
      className="flex items-center justify-center text-blue-600 hover:text-blue-700 hover:bg-blue-50 h-10 w-10 p-0 rounded-full shadow-md hover:shadow-lg active:shadow-sm active:translate-y-0.5 transition-all"
      title="Print Receipt"
    >
